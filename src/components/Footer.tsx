...
function SocialIcon({ name }: { name: string }) {
  return (
    <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-surface-dark text-text-secondary transition-colors hover:bg-brand-orange hover:text-brand-black">
      {name === "Instagram" && (
