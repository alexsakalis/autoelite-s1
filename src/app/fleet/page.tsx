    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              >
                Reliable maintenance, priority scheduling, and preventative programs for commercial and fleet vehicles in Montreal.
              </motion.p>
              <motion.div
      ...
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <SectionHeading
            ...
            subtitle="Tailored solutions for businesses that depend on their vehicles."
          />
      ...
      <section className="border-t border-surface-border bg-surface py-20 sm:py-24">
        <div className="mx-auto max-w-4xl px-5 text-center lg:px-8">
          <SectionHeading
            label="Why us"
            title="Why Businesses Choose Autoelite"
            subtitle="We understand that fleet downtime costs money. That's why we offer dedicated fleet scheduling, transparent reporting, and consistent quality across every vehicle."
          />
          <FadeIn delay={0.1}>
            <div className="mt-14 grid gap-6 sm:grid-cols-3">
              {[
                { stat: "500+", label: "Fleet vehicles serviced" },
                { stat: "Same Day", label: "Priority turnaround" },
      ...
      <CTASection
        title="Ready to streamline your fleet maintenance?"
        subtitle="Contact us for a custom fleet service plan."
        buttonLabel="Request Fleet Service"
      />
    </>
  );
}
