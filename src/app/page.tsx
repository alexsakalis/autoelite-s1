...
const WHY_CHOOSE = [
  {
    ...
    desc: "Certified professionals with years of hands-on experience across all makes and models.",
    icon: (
  ...
  },
  {
    ...
    desc: "Straightforward assessments and transparent pricing — no unnecessary upsells, ever.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: "Quality Parts",
    desc: "We use trusted OEM and aftermarket parts for results that last.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    desc: "From daily drivers to tuned builds — we know how to get the most from your car.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export default function HomePage() {
  return (
    <>
      <HeroSection
        title="Premium Automotive Service You Can Trust"
        subtitle="Professional diagnostics, repairs, and performance upgrades in Montreal — backed by honest technicians and quality parts."
      ...
      <section className="border-t border-surface-border bg-surface py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <SectionHeading
            ...
            subtitle="Built on trust, expertise, and a passion for keeping your vehicle at its best."
          />
      ...
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <SectionHeading
            label="What we do"
            title="Our Services"
            subtitle="From routine maintenance to performance upgrades — serving Montreal and the West Island."
          />
      ...
      <MidPageCTA
        ...
        subtext="Book your service today — fast and easy online scheduling."
      />
      ...
      <section className="border-t border-surface-border bg-surface py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <SectionHeading label="Our work" title="Gallery" />
      ...
      {/* Mid-page CTA */}
      <MidPageCTA
        heading="Ready to get your car in top shape?"
        subtext="Schedule your appointment online — we'll take care of the rest."
