...
export default function ContactPage() {
  return (
    <>
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <SectionHeading
            ...
            subtitle="Send us a message or book your appointment directly online."
          />
          ...
          <div className="mt-14 grid gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            >
              ...
              <div className="rounded-2xl border border-brand-orange/30 bg-brand-orange/5 p-6">
                <h3 className="font-bold text-white">Prefer to book directly?</h3>
                <p className="mt-2 text-sm text-text-secondary">
                  Skip the form and schedule your appointment online.
                </p>
                <a
                  href={BOOK_NOW_URL}
                  target="_blank"
      ...
      <CTASection title="Prefer to book directly?" subtitle="Schedule your appointment in minutes." buttonLabel="Book Now" />
    </>
  );
}
